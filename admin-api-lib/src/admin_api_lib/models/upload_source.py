...
class UploadSource(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UploadSource from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UploadSource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "file": obj.get("file"),
            "type": obj.get("type"),
            "kwargs": [KeyValuePair.from_dict(_item) for _item in obj.get("kwargs")] if obj.get("kwargs") is not None else None
        })
        return _obj
